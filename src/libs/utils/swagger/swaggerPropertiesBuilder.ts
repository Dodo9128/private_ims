...
export class SwaggerProperties {
  ...
  constructor(result: ISwaggerProperties, message: ISwaggerProperties, data: ISwaggerProperties) {
    this.result = result;
...
export class SwaggerPropertiesBuilder {
  ...
  public makeOkObj(message: string, data: string | object | null): this {
  ...
  public makeFailObj(message: string): this {
